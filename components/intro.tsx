...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Suirita Fahd.</span> I'm a{" "}
      ...
      >
        ...
        <div className="flex gap-2 ">
          <a
            ...
            href="https://www.linkedin.com/in/fahd-suirita-659238284/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
